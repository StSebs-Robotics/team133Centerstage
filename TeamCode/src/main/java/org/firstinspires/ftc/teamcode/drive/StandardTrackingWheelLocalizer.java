...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.4518; // in; distance between the left and right wheels
    ...
    public static double Y_MULTIPLIER = 0.9717571606; // Multiplier in the Y direction
