...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.4639; // in; distance between the left and right wheels
    ...
    public static double Y_MULTIPLIER = 1.039; // Multiplier in the Y direction
