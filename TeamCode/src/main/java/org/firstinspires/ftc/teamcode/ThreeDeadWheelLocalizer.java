...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2176.095138450547; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2392.299412449846; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2139.5964855247826; // x position of the perpendicular encoder (in tick units)
    }
